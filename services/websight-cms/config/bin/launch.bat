...
%JAVACMD% %JAVA_OPTS% -Dproject.artifactId=org.apache.sling.feature.launcher -Dproject.version=1.2.4 -Dbuild.timestamp=2023-01-06T10:31:36Z -Dfile.encoding=UTF-8 -classpath %CLASSPATH% -Dapp.name="launcher" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.apache.sling.feature.launcher.impl.Main %CMD_LINE_ARGS%

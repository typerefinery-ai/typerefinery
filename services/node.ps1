Param(
  ...
  [string]$SERVER_HOME = ( Join-Path "${PWD}" "${SERVICE_NAME}" "node-${NODE_VERSION}-${OS}-${CPU_ARCH}"),
  [string]$NODE_PROGRAM_PATH = ( Join-Path "${PWD}" "${SERVICE_NAME}" "node-${NODE_VERSION}-${OS}-${CPU_ARCH}" "bin" "node"),
  [string]$NPM_PROGRAM_PATH = ( Join-Path "${PWD}" "${SERVICE_NAME}" "node-${NODE_VERSION}-${OS}-${CPU_ARCH}" "bin" "npm"),

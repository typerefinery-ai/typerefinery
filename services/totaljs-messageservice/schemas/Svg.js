...
NEWSCHEMA("Svg", function (schema) {
  console.log(schema)
  schema.define("error", "String")
  schema.define("output.name", "String")
  schema.define("output", "String")
  schema.define("output.exists", "String")
  schema.define("output.url", "String")
  schema.define("log", "String")
  schema.define("log.exists", "String")
  schema.define("log.url", "String")
  schema.define("return.output", "string")
  schema.define("Access-Control-Expose-Headers", "string")

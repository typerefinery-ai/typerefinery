...
from typedb_protocol.common import connection_pb2 as common_dot_connection__pb2
...
class TypeDBStub(object):
  ...
  def __init__(self, channel):
    ...
    """
    self.connection_open = channel.unary_unary(
        '/typedb.protocol.TypeDB/connection_open',
        request_serializer=common_dot_connection__pb2.Connection.Open.Req.SerializeToString,
        response_deserializer=common_dot_connection__pb2.Connection.Open.Res.FromString,
        )
...
class TypeDBServicer(object):
  ...
  def connection_open(self, request, context):
    # missing associated documentation comment in .proto file
    pass
...
def add_TypeDBServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'connection_open': grpc.unary_unary_rpc_method_handler(
          servicer.connection_open,
          request_deserializer=common_dot_connection__pb2.Connection.Open.Req.FromString,
          response_serializer=common_dot_connection__pb2.Connection.Open.Res.SerializeToString,
      ),

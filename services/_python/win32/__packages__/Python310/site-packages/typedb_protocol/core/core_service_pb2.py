...
_TYPEDB = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='typedb.protocol.TypeDB.connection_open',
    index=0,
    containing_service=None,
    input_type=common_dot_connection__pb2._CONNECTION_OPEN_REQ,
    output_type=common_dot_connection__pb2._CONNECTION_OPEN_RES,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(

...
class TypeDBClusterStub(object):
  ...
  def __init__(self, channel):
    ...
    self.users_delete = channel.unary_unary(
        '/typedb.protocol.TypeDBCluster/users_delete',
        request_serializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Delete.Req.SerializeToString,
        response_deserializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Delete.Res.FromString,
        )
    ...
    self.users_password_set = channel.unary_unary(
        '/typedb.protocol.TypeDBCluster/users_password_set',
        request_serializer=cluster_dot_cluster__user__pb2.ClusterUserManager.PasswordSet.Req.SerializeToString,
        response_deserializer=cluster_dot_cluster__user__pb2.ClusterUserManager.PasswordSet.Res.FromString,
        )
    self.users_get = channel.unary_unary(
        '/typedb.protocol.TypeDBCluster/users_get',
        request_serializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Get.Req.SerializeToString,
        response_deserializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Get.Res.FromString,
        )
    self.user_password_update = channel.unary_unary(
        '/typedb.protocol.TypeDBCluster/user_password_update',
        request_serializer=cluster_dot_cluster__user__pb2.ClusterUser.PasswordUpdate.Req.SerializeToString,
        response_deserializer=cluster_dot_cluster__user__pb2.ClusterUser.PasswordUpdate.Res.FromString,
        )
...
class TypeDBClusterServicer(object):
  ...
  def users_delete(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
  ...
  def users_password_set(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
  ...
  def users_get(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
  ...
  def user_password_update(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_TypeDBClusterServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'users_delete': grpc.unary_unary_rpc_method_handler(
          servicer.users_delete,
          request_deserializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Delete.Req.FromString,
          response_serializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Delete.Res.SerializeToString,
      ),
      ...
      'users_password_set': grpc.unary_unary_rpc_method_handler(
          servicer.users_password_set,
          request_deserializer=cluster_dot_cluster__user__pb2.ClusterUserManager.PasswordSet.Req.FromString,
          response_serializer=cluster_dot_cluster__user__pb2.ClusterUserManager.PasswordSet.Res.SerializeToString,
      ),
      'users_get': grpc.unary_unary_rpc_method_handler(
          servicer.users_get,
          request_deserializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Get.Req.FromString,
          response_serializer=cluster_dot_cluster__user__pb2.ClusterUserManager.Get.Res.SerializeToString,
      ),
      'user_password_update': grpc.unary_unary_rpc_method_handler(
          servicer.user_password_update,
          request_deserializer=cluster_dot_cluster__user__pb2.ClusterUser.PasswordUpdate.Req.FromString,
          response_serializer=cluster_dot_cluster__user__pb2.ClusterUser.PasswordUpdate.Res.SerializeToString,
      ),
